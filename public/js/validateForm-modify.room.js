...
$(document).ready(function() {
    ...
    function validateSelectInput(selectInput, selectInputId, selectInputErrorId, selectInputErrorMsg) {
        ...
        if(!options.includes(selectInput.toLowerCase())){
    ...
    $('#modifyRoomForm').submit(function(event) {
        ...
        let roomTypeValid = validateSelectInput(formRoomType, ROOM_TYPE_INPUT_ID, ROOM_TYPE_ERROR_ID, ROOM_TYPE_REQUIRED);
    ...
    const ROOM_NAME_REQUIRED = "S'il-te-plaît, Entre ton prénom";
    ...
    const NUMBER_OF_ROOMS_REQUIRED = "S'il-te-plaît, entre le numbre de chambres";
